...
**     Filename    : FreeRTOS1.c
**     Project     : CB_Test
**     Processor   : MK22FN512VLH12
**     Component   : FreeRTOS
**     Version     : Component 01.406, Driver 01.00, CPU db: 3.00.000
**     Compiler    : GNU C Compiler
**     Date/Time   : 2015-02-19, 21:13, # CodeGen: 30
**     Abstract    :
**          This component implements the FreeRTOS Realtime Operating System
**     Settings    :
**          Component name                                 : FreeRTOS1
**          RTOS Version                                   : V8.2.0
...
**          Collect Runtime Statistics                     : Enabled
**            LDD                                          : Disabled
**            non-LDD                                      : Disabled
...
**            Stackoverflow checking method                : Method 2
...
**          Utility                                        : UTIL1
**     Contents    :
**         xTaskCreate                    - portBASE_TYPE FreeRTOS1_xTaskCreate(pdTASK_CODE pvTaskCode, const portCHAR *...
**         vTaskStartScheduler            - void FreeRTOS1_vTaskStartScheduler(void);
**         vTaskSuspend                   - void FreeRTOS1_vTaskSuspend(xTaskHandle pxTaskToSuspend);
**         vTaskSuspendAll                - void FreeRTOS1_vTaskSuspendAll(void);
**         vTaskResume                    - void FreeRTOS1_vTaskResume(xTaskHandle pxTaskToResume);
**         xTaskResumeAll                 - portBASE_TYPE FreeRTOS1_xTaskResumeAll(void);
**         xTaskResumeFromISR             - portBASE_TYPE FreeRTOS1_xTaskResumeFromISR(xTaskHandle pxTaskToResume);
**         taskYIELD                      - void FreeRTOS1_taskYIELD(void);
**         taskENTER_CRITICAL             - void FreeRTOS1_taskENTER_CRITICAL(void);
**         taskEXIT_CRITICAL              - void FreeRTOS1_taskEXIT_CRITICAL(void);
**         taskDISABLE_INTERRUPTS         - void FreeRTOS1_taskDISABLE_INTERRUPTS(void);
**         taskENABLE_INTERRUPTS          - void FreeRTOS1_taskENABLE_INTERRUPTS(void);
**         vTaskDelay                     - void FreeRTOS1_vTaskDelay(portTickType xTicksToDelay);
**         vTaskDelayUntil                - void FreeRTOS1_vTaskDelayUntil(portTickType *pxPreviousWakeTime, portTickType...
**         uxTaskPriorityGet              - unsigned_portBASE_TYPE FreeRTOS1_uxTaskPriorityGet(xTaskHandle pxTask);
**         vTaskPrioritySet               - void FreeRTOS1_vTaskPrioritySet(xTaskHandle pxTask, unsigned_portBASE_TYPE...
**         xTaskGetTickCount              - portTickType FreeRTOS1_xTaskGetTickCount(void);
**         xTaskGetTickCountFromISR       - portTickType FreeRTOS1_xTaskGetTickCountFromISR(void);
**         xSemaphoreCreateRecursiveMutex - xSemaphoreHandle FreeRTOS1_xSemaphoreCreateRecursiveMutex(void);
**         xSemaphoreTakeRecursive        - bool FreeRTOS1_xSemaphoreTakeRecursive(xSemaphoreHandle xMutex, portTickType...
**         xSemaphoreGiveRecursive        - bool FreeRTOS1_xSemaphoreGiveRecursive(xSemaphoreHandle xMutex);
**         xSemaphoreCreateMutex          - xSemaphoreHandle FreeRTOS1_xSemaphoreCreateMutex(void);
**         xSemaphoreTake                 - bool FreeRTOS1_xSemaphoreTake(xSemaphoreHandle xMutex, portTickType xBlockTime);
**         xSemaphoreGive                 - bool FreeRTOS1_xSemaphoreGive(xSemaphoreHandle xMutex);
**         vSemaphoreCreateBinary         - void FreeRTOS1_vSemaphoreCreateBinary(xSemaphoreHandle xSemaphore);
**         xSemaphoreCreateCounting       - xSemaphoreHandle FreeRTOS1_xSemaphoreCreateCounting(unsigned_portBASE_TYPE...
**         xSemaphoreGiveFromISR          - bool FreeRTOS1_xSemaphoreGiveFromISR(xSemaphoreHandle xSemaphore,...
**         xSemaphoreTakeFromISR          - bool FreeRTOS1_xSemaphoreTakeFromISR(xSemaphoreHandle xSemaphore,...
**         vSemaphoreDelete               - void FreeRTOS1_vSemaphoreDelete(xSemaphoreHandle xSemaphore);
**         xSemaphoreGetMutexHolder       - void* FreeRTOS1_xSemaphoreGetMutexHolder(xSemaphoreHandle xSemaphore);
**         pvPortMalloc                   - pVoid FreeRTOS1_pvPortMalloc(size_t xWantedSize);
**         vPortFree                      - void FreeRTOS1_vPortFree(void *pv);
**         xPortGetFreeHeapSize           - Tsize_t FreeRTOS1_xPortGetFreeHeapSize(void);
**         xTaskGetSchedulerState         - portBASE_TYPE FreeRTOS1_xTaskGetSchedulerState(void);
**         vTaskList                      - void FreeRTOS1_vTaskList(signed portCHAR *pcWriteBuffer, size_t bufSize);
**         uxTaskGetStackHighWaterMark    - unsigned_portBASE_TYPE FreeRTOS1_uxTaskGetStackHighWaterMark(xTaskHandle xTask);
**         uxTaskGetNumberOfTasks         - unsigned_portBASE_TYPE FreeRTOS1_uxTaskGetNumberOfTasks(void);
**         vTaskGetRunTimeStats           - void FreeRTOS1_vTaskGetRunTimeStats(portCHAR *pcWriteBuffer, size_t bufSize);
**         uxQueueMessagesWaiting         - unsigned_portBASE_TYPE FreeRTOS1_uxQueueMessagesWaiting(xQueueHandle xQueue);
**         uxQueueMessagesWaitingfromISR  - unsigned_portBASE_TYPE FreeRTOS1_uxQueueMessagesWaitingfromISR(xQueueHandle...
**         xQueueCreate                   - xQueueHandle FreeRTOS1_xQueueCreate(unsigned_portBASE_TYPE uxQueueLength,...
**         vQueueDelete                   - void FreeRTOS1_vQueueDelete(xQueueHandle pxQueueToDelete);
**         xQueueReset                    - portBASE_TYPE FreeRTOS1_xQueueReset(xQueueHandle xQueue);
**         xQueueSendToBack               - portBASE_TYPE FreeRTOS1_xQueueSendToBack(xQueueHandle xQueue, const void...
**         xQueueSendToFront              - portBASE_TYPE FreeRTOS1_xQueueSendToFront(xQueueHandle xQueue, const void...
**         xQueueReceive                  - portBASE_TYPE FreeRTOS1_xQueueReceive(xQueueHandle xQueue, void *pvBuffer,...
**         xQueueOverwrite                - portBASE_TYPE FreeRTOS1_xQueueOverwrite(xQueueHandle xQueue, const void...
**         xQueueOverwriteFromISR         - portBASE_TYPE FreeRTOS1_xQueueOverwriteFromISR(xQueueHandle xQueue, const...
**         xQueuePeek                     - portBASE_TYPE FreeRTOS1_xQueuePeek(xQueueHandle xQueue, void *pvBuffer,...
**         xQueuePeekFromISR              - portBASE_TYPE FreeRTOS1_xQueuePeekFromISR(xQueueHandle xQueue, void...
**         xQueueSendToBackFromISR        - portBASE_TYPE FreeRTOS1_xQueueSendToBackFromISR(xQueueHandle xQueue, const...
**         xQueueSendToFrontFromISR       - portBASE_TYPE FreeRTOS1_xQueueSendToFrontFromISR(xQueueHandle xQueue, const...
**         xQueueReceiveFromISR           - portBASE_TYPE FreeRTOS1_xQueueReceiveFromISR(xQueueHandle xQueue, void...
**         vQueueAddToRegistry            - void FreeRTOS1_vQueueAddToRegistry(xQueueHandle xQueue, char *pcQueueName);
**         vQueueUnregisterQueue          - void FreeRTOS1_vQueueUnregisterQueue(xQueueHandle xQueue);
**         xQueueIsQueueFullFromISR       - portBASE_TYPE FreeRTOS1_xQueueIsQueueFullFromISR(xQueueHandle xQueue);
**         xQueueIsQueueEmptyFromISR      - portBASE_TYPE FreeRTOS1_xQueueIsQueueEmptyFromISR(xQueueHandle xQueue);
**         xEventGroupCreate              - EventGroupHandle_t FreeRTOS1_xEventGroupCreate(void);
**         xEventGroupWaitBits            - byte FreeRTOS1_xEventGroupWaitBits(const EventGroupHandle_t xEventGroup,...
**         xEventGroupSetBits             - EventBits_t FreeRTOS1_xEventGroupSetBits(EventGroupHandle_t xEventGroup,...
**         xEventGroupSetBitsFromISR      - EventBits_t FreeRTOS1_xEventGroupSetBitsFromISR(EventGroupHandle_t...
**         xEventGroupClearBits           - EventBits_t FreeRTOS1_xEventGroupClearBits(EventGroupHandle_t xEventGroup,...
**         xEventGroupClearBitsFromISR    - EventBits_t FreeRTOS1_xEventGroupClearBitsFromISR(EventGroupHandle_t...
**         xEventGroupGetBits             - EventBits_t FreeRTOS1_xEventGroupGetBits(EventGroupHandle_t xEventGroup);
**         xEventGroupGetBitsFromISR      - EventBits_t FreeRTOS1_xEventGroupGetBitsFromISR(EventGroupHandle_t xEventGroup);
**         xEventGroupSync                - EventBits_t FreeRTOS1_xEventGroupSync(EventGroupHandle_t xEventGroup, const...
**         xTimerCreate                   - TimerHandle_t FreeRTOS1_xTimerCreate(const char * const pcTimerName, const...
**         xTimerIsTimerActive            - BaseType_t FreeRTOS1_xTimerIsTimerActive(TimerHandle_t xTimer);
**         xTimerStart                    - BaseType_t FreeRTOS1_xTimerStart(TimerHandle_t xTimer, TickType_t xBlockTime);
**         xTimerStop                     - BaseType_t FreeRTOS1_xTimerStop(TimerHandle_t xTimer, TickType_t xBlockTime);
**         xTimerChangePeriod             - BaseType_t FreeRTOS1_xTimerChangePeriod(TimerHandle_t xTimer, TickType_t...
**         xTimerDelete                   - BaseType_t FreeRTOS1_xTimerDelete(TickType_t xTimer, TickType_t xBlockTime);
**         xTimerReset                    - BaseType_t FreeRTOS1_xTimerReset(TimerHandle_t xTimer, TickType_t xBlockTime);
**         xTimerStartFromISR             - BaseType_t FreeRTOS1_xTimerStartFromISR(TimerHandle_t xTimer, BaseType_t...
**         xTimerStopFromISR              - BaseType_t FreeRTOS1_xTimerStopFromISR(TimerHandle_t xTimer, BaseType_t...
**         xTimerChangePeriodFromISR      - BaseType_t FreeRTOS1_xTimerChangePeriodFromISR(TimerHandle_t xTimer,...
**         xTimerResetFromISR             - BaseType_t FreeRTOS1_xTimerResetFromISR(TimerHandle_t xTimer, BaseType_t...
**         pvTimerGetTimerID              - void* FreeRTOS1_pvTimerGetTimerID(TimerHandle_t xTimer);
**         xTimerGetTimerDaemonTaskHandle - TaskHandle_t FreeRTOS1_xTimerGetTimerDaemonTaskHandle(void);
**         pcTimerGetTimerName            - char* FreeRTOS1_pcTimerGetTimerName(TimerHandle_t xTimer);
**         xTimerPendFunctionCall         - BaseType_t FreeRTOS1_xTimerPendFunctionCall(PendedFunction_t xFunctionToPend,...
**         xTimerPendFunctionCallFromISR  - BaseType_t FreeRTOS1_xTimerPendFunctionCallFromISR(PendedFunction_t...
**         xTaskNotifyGive                - BaseType_t FreeRTOS1_xTaskNotifyGive(TaskHandle_t xTaskToNotify);
**         vTaskNotifyGiveFromISR         - void FreeRTOS1_vTaskNotifyGiveFromISR(TaskHandle_t xTaskToNotify, BaseType_t...
**         ulTaskNotifyTake               - uint32_t FreeRTOS1_ulTaskNotifyTake(BaseType_t xClearCountOnExit, TickType_t...
**         xTaskNotify                    - BaseType_t FreeRTOS1_xTaskNotify(TaskHandle_t xTaskToNotify, uint32_t...
**         xTaskNotifyFromISR             - BaseType_t FreeRTOS1_xTaskNotifyFromISR(TaskHandle_t xTaskToNotify, uint32_t...
**         xTaskNotifyWait                - BaseType_t FreeRTOS1_xTaskNotifyWait(uint32_t ulBitsToClearOnEntry, uint32_t...
**         Init                           - void FreeRTOS1_Init(void);
**
...
*/         
/*!
**  @addtogroup FreeRTOS1_module FreeRTOS1 module documentation
**  @{
*/         
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTaskCreate (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xTaskCreate(pdTASK_CODE pvTaskCode, const portCHAR * const pcName, unsigned portSHORT usStackDepth, void *pvParameters, unsigned portBASE_TYPE uxPriority, xTaskHandle *pvCreatedTask)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/

/*
** ===================================================================
**     Method      :  FreeRTOS1_vTaskStartScheduler (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vTaskStartScheduler(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_taskYIELD (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_taskENTER_CRITICAL (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_taskENTER_CRITICAL(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_taskEXIT_CRITICAL (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_taskEXIT_CRITICAL(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_taskDISABLE_INTERRUPTS (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_taskDISABLE_INTERRUPTS(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_taskENABLE_INTERRUPTS (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_taskENABLE_INTERRUPTS(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vTaskSuspendAll (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vTaskSuspendAll(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTaskResumeAll (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xTaskResumeAll(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTaskResumeFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xTaskResumeFromISR(xTaskHandle pxTaskToResume)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vTaskDelay (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vTaskDelay(portTickType xTicksToDelay)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vTaskDelayUntil (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vTaskDelayUntil(portTickType *pxPreviousWakeTime, portTickType xTimeIncrement)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_uxTaskPriorityGet (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FreeRTOS1_uxTaskPriorityGet(xTaskHandle pxTask)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vTaskPrioritySet (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vTaskPrioritySet(xTaskHandle pxTask, unsigned_portBASE_TYPE uxNewPriority)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xSemaphoreTakeRecursive (component FreeRTOS)
**     Description :
...
*/
/*
bool FreeRTOS1_xSemaphoreTakeRecursive(xSemaphoreHandle xMutex, portTickType xBlockTime)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xSemaphoreGiveRecursive (component FreeRTOS)
**     Description :
...
*/
/*
bool FreeRTOS1_xSemaphoreGiveRecursive(xSemaphoreHandle xMutex)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xSemaphoreCreateRecursiveMutex (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle FreeRTOS1_xSemaphoreCreateRecursiveMutex(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vSemaphoreDelete (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vSemaphoreDelete(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vTaskSuspend (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vTaskSuspend(xTaskHandle pxTaskToSuspend)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vTaskResume (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vTaskResume(xTaskHandle pxTaskToResume)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xSemaphoreCreateMutex (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle FreeRTOS1_xSemaphoreCreateMutex(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xSemaphoreTake (component FreeRTOS)
**     Description :
...
*/
/*
bool FreeRTOS1_xSemaphoreTake(xSemaphoreHandle xMutex, portTickType xBlockTime)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xSemaphoreGive (component FreeRTOS)
**     Description :
...
*/
/*
bool FreeRTOS1_xSemaphoreGive(xSemaphoreHandle xMutex)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vSemaphoreCreateBinary (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vSemaphoreCreateBinary(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xSemaphoreCreateCounting (component FreeRTOS)
**     Description :
...
*/
/*
xSemaphoreHandle FreeRTOS1_xSemaphoreCreateCounting(unsigned_portBASE_TYPE uxMaxCount, unsigned_portBASE_TYPE uxInitialCount)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xSemaphoreGiveFromISR (component FreeRTOS)
**     Description :
**         Macro to release a semaphore. The semaphore must have
**         previously been created with a call to
...
*/
/*
bool FreeRTOS1_xSemaphoreGiveFromISR(xSemaphoreHandle xSemaphore, signed_portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vTaskList (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vTaskList(signed portCHAR *pcWriteBuffer, size_t bufSize)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_pvPortMalloc (component FreeRTOS)
**     Description :
...
*/
/*
pVoid FreeRTOS1_pvPortMalloc(size_t xWantedSize)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vPortFree (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vPortFree(void *pv)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTaskGetTickCount (component FreeRTOS)
**     Description :
...
*/
/*
portTickType FreeRTOS1_xTaskGetTickCount(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTaskGetSchedulerState (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xTaskGetSchedulerState(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_uxTaskGetStackHighWaterMark (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FreeRTOS1_uxTaskGetStackHighWaterMark(xTaskHandle xTask)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_uxTaskGetNumberOfTasks (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FreeRTOS1_uxTaskGetNumberOfTasks(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vTaskGetRunTimeStats (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vTaskGetRunTimeStats(portCHAR *pcWriteBuffer, size_t bufSize)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xPortGetFreeHeapSize (component FreeRTOS)
**     Description :
...
*/
/*
Tsize_t FreeRTOS1_xPortGetFreeHeapSize(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueCreate (component FreeRTOS)
**     Description :
**         Creates a queue.
**     Parameters  :
**         NAME            - DESCRIPTION
...
*/
/*
xQueueHandle FreeRTOS1_xQueueCreate(unsigned_portBASE_TYPE uxQueueLength, unsigned_portBASE_TYPE uxItemSize)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueSendToFront (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueueSendToFront(xQueueHandle xQueue, const void *pvItemToQueue, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueSendToBack (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueueSendToBack(xQueueHandle xQueue, const void *pvItemToQueue, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueReceive (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueueReceive(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueuePeek (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueuePeek(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vQueueDelete (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vQueueDelete(xQueueHandle pxQueueToDelete)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_uxQueueMessagesWaiting (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FreeRTOS1_uxQueueMessagesWaiting(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_uxQueueMessagesWaitingfromISR (component FreeRTOS)
**     Description :
...
*/
/*
unsigned_portBASE_TYPE FreeRTOS1_uxQueueMessagesWaitingfromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueReceiveFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueueReceiveFromISR(xQueueHandle xQueue, void *pvBuffer, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueSendToFrontFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueueSendToFrontFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueSendToBackFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueueSendToBackFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueReset (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueueReset(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xSemaphoreGetMutexHolder (component FreeRTOS)
**     Description :
...
*/
/*
void* FreeRTOS1_xSemaphoreGetMutexHolder(xSemaphoreHandle xSemaphore)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xSemaphoreTakeFromISR (component FreeRTOS)
**     Description :
...
*/
/*
bool FreeRTOS1_xSemaphoreTakeFromISR(xSemaphoreHandle xSemaphore, signed_portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_Init (component FreeRTOS)
**     Description :
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTaskGetTickCountFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portTickType FreeRTOS1_xTaskGetTickCountFromISR(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueuePeekFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueuePeekFromISR(xQueueHandle xQueue, void *pvBuffer, portTickType xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueOverwrite (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueueOverwrite(xQueueHandle xQueue, const void *pvItemToQueue)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueOverwriteFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueueOverwriteFromISR(xQueueHandle xQueue, const void *pvItemToQueue, portBASE_TYPE *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vQueueAddToRegistry (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vQueueAddToRegistry(xQueueHandle xQueue, char *pcQueueName)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vQueueUnregisterQueue (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vQueueUnregisterQueue(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueIsQueueFullFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueueIsQueueFullFromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xQueueIsQueueEmptyFromISR (component FreeRTOS)
**     Description :
...
*/
/*
portBASE_TYPE FreeRTOS1_xQueueIsQueueEmptyFromISR(xQueueHandle xQueue)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xEventGroupCreate (component FreeRTOS)
**     Description :
...
*/
/*
EventGroupHandle_t FreeRTOS1_xEventGroupCreate(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xEventGroupWaitBits (component FreeRTOS)
**     Description :
...
*/
/*
byte FreeRTOS1_xEventGroupWaitBits(const EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToWaitFor, const BaseType_t xClearOnExit, const BaseType_t xWaitForAllBits, TickType_t xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xEventGroupSetBits (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FreeRTOS1_xEventGroupSetBits(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xEventGroupSetBitsFromISR (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FreeRTOS1_xEventGroupSetBitsFromISR(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet , BaseType_t *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xEventGroupClearBits (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FreeRTOS1_xEventGroupClearBits(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xEventGroupClearBitsFromISR (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FreeRTOS1_xEventGroupClearBitsFromISR(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet )
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xEventGroupGetBits (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FreeRTOS1_xEventGroupGetBits(EventGroupHandle_t xEventGroup)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xEventGroupGetBitsFromISR (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FreeRTOS1_xEventGroupGetBitsFromISR(EventGroupHandle_t xEventGroup)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xEventGroupSync (component FreeRTOS)
**     Description :
...
*/
/*
EventBits_t FreeRTOS1_xEventGroupSync(EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet, const EventBits_t uxBitsToWaitFor, TickType_t xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerCreate (component FreeRTOS)
**     Description :
...
*/
/*
TimerHandle_t FreeRTOS1_xTimerCreate(const char * const pcTimerName, const TickType_t xTimerPeriod, const UBaseType_t uxAutoReload, void *const pvTimerID, TimerCallbackFunction_t pxCallbackFunction)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerIsTimerActive (component FreeRTOS)
**     Description :
...
*/
/*
BaseType_t FreeRTOS1_xTimerIsTimerActive(TimerHandle_t xTimer)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerStart (component FreeRTOS)
**     Description :
...
*/
/*
BaseType_t FreeRTOS1_xTimerStart(TimerHandle_t xTimer, TickType_t xBlockTime)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerStop (component FreeRTOS)
**     Description :
**          Timer functionality is provided by a timer service/daemon
**         task. Many of the public FreeRTOS timer API functions send
**         commands to the timer service task through a queue called
...
*/
/*
BaseType_t FreeRTOS1_xTimerStop(TimerHandle_t xTimer, TickType_t xBlockTime)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerChangePeriod (component FreeRTOS)
**     Description :
**          Timer functionality is provided by a timer service/daemon
**         task. Many of the public FreeRTOS timer API functions send
**         commands to the timer service task through a queue called
...
*/
/*
BaseType_t FreeRTOS1_xTimerChangePeriod(TimerHandle_t xTimer, TickType_t xNewPeriod, TickType_t xBlockTime)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerDelete (component FreeRTOS)
**     Description :
**          Timer functionality is provided by a timer service/daemon
**         task. Many of the public FreeRTOS timer API functions send
**         commands to the timer service task through a queue called
...
*/
/*
BaseType_t FreeRTOS1_xTimerDelete(TickType_t xTimer, TickType_t xBlockTime)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerReset (component FreeRTOS)
**     Description :
**          Timer functionality is provided by a timer service/daemon
**         task. Many of the public FreeRTOS timer API functions send
**         commands to the timer service task through a queue called
...
*/
/*
BaseType_t FreeRTOS1_xTimerReset(TimerHandle_t xTimer, TickType_t xBlockTime)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerStartFromISR (component FreeRTOS)
**     Description :
...
*/
/*
BaseType_t FreeRTOS1_xTimerStartFromISR(TimerHandle_t xTimer, BaseType_t *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerStopFromISR (component FreeRTOS)
**     Description :
...
*/
/*
BaseType_t FreeRTOS1_xTimerStopFromISR(TimerHandle_t xTimer, BaseType_t *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerChangePeriodFromISR (component FreeRTOS)
**     Description :
...
*/
/*
BaseType_t FreeRTOS1_xTimerChangePeriodFromISR(TimerHandle_t xTimer, TickType_t xNewPeriod, BaseType_t *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerResetFromISR (component FreeRTOS)
**     Description :
...
*/
/*
BaseType_t FreeRTOS1_xTimerResetFromISR(TimerHandle_t xTimer, BaseType_t *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_pvTimerGetTimerID (component FreeRTOS)
**     Description :
...
*/
/*
void* FreeRTOS1_pvTimerGetTimerID(TimerHandle_t xTimer)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerGetTimerDaemonTaskHandle (component FreeRTOS)
**     Description :
...
*/
/*
TaskHandle_t FreeRTOS1_xTimerGetTimerDaemonTaskHandle(void)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_pcTimerGetTimerName (component FreeRTOS)
**     Description :
**         
**     Parameters  :
**         NAME            - DESCRIPTION
...
*/
/*
char* FreeRTOS1_pcTimerGetTimerName(TimerHandle_t xTimer)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerPendFunctionCall (component FreeRTOS)
**     Description :
...
*/
/*
BaseType_t FreeRTOS1_xTimerPendFunctionCall(PendedFunction_t xFunctionToPend, void* pvParameter1, uint32_t ulParameter2, TickType_t xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTimerPendFunctionCallFromISR (component FreeRTOS)
**     Description :
...
*/
/*
BaseType_t FreeRTOS1_xTimerPendFunctionCallFromISR(PendedFunction_t xFunctionToPend, void* pvParameter1, uint32_t ulParameter2, BaseType_t *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTaskNotifyGive (component FreeRTOS)
**     Description :
...
*/
/*
BaseType_t FreeRTOS1_xTaskNotifyGive(TaskHandle_t xTaskToNotify)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_ulTaskNotifyTake (component FreeRTOS)
**     Description :
**          Each RTOS task has a 32-bit notification value which is
**         initialised to zero when the RTOS task is created. An RTOS
**         task notification is an event sent directly to a task that
...
*/
/*
uint32_t FreeRTOS1_ulTaskNotifyTake(BaseType_t xClearCountOnExit, TickType_t xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_vTaskNotifyGiveFromISR (component FreeRTOS)
**     Description :
...
*/
/*
void FreeRTOS1_vTaskNotifyGiveFromISR(TaskHandle_t xTaskToNotify, BaseType_t *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTaskNotify (component FreeRTOS)
**     Description :
...
*/
/*
BaseType_t FreeRTOS1_xTaskNotify(TaskHandle_t xTaskToNotify, uint32_t ulValue, eNotifyAction eAction)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTaskNotifyFromISR (component FreeRTOS)
**     Description :
**          [If you are using RTOS task notifications to implement
**         binary or counting semaphore type behaviour then use the
**         simpler xTaskNotifyGive() API function instead of
...
*/
/*
BaseType_t FreeRTOS1_xTaskNotifyFromISR(TaskHandle_t xTaskToNotify, uint32_t ulValue, eNotifyAction eAction, BaseType_t *pxHigherPriorityTaskWoken)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
...
/*
** ===================================================================
**     Method      :  FreeRTOS1_xTaskNotifyWait (component FreeRTOS)
**     Description :
**          [If you are using RTOS task notifications to implement
**         binary or counting semaphore type behaviour then use the
...
*/
/*
BaseType_t FreeRTOS1_xTaskNotifyWait(uint32_t ulBitsToClearOnEntry, uint32_t ulBitsToClearOnExit, uint32_t *pulNotificationValue, TickType_t xTicksToWait)
{
  *** Implemented as macro in the header file FreeRTOS1.h
}
*/
