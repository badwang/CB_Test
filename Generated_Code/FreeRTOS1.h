...
#ifndef __FreeRTOS1_H
#define __FreeRTOS1_H
...
#define FreeRTOS1_PARSE_COMMAND_ENABLED  0 /* set to 1 if method ParseCommand() is present, 0 otherwise */
...
#define PEX_RTOS_START()               FreeRTOS1_vTaskStartScheduler()
...
#define FreeRTOS1_xTaskCreate(pvTaskCode, pcName, usStackDepth, pvParameters, uxPriority, pvCreatedTask) \
...
#define FreeRTOS1_vTaskStartScheduler() \
  vTaskStartScheduler()
/*
** ===================================================================
...
#define FreeRTOS1_taskENTER_CRITICAL() \
  taskENTER_CRITICAL()
/*
** ===================================================================
...
#define FreeRTOS1_taskEXIT_CRITICAL() \
  taskEXIT_CRITICAL()
/*
** ===================================================================
...
#define FreeRTOS1_taskDISABLE_INTERRUPTS() \
...
#define FreeRTOS1_taskENABLE_INTERRUPTS() \
...
#define FreeRTOS1_vTaskSuspendAll() \
  vTaskSuspendAll()
/*
** ===================================================================
...
#define FreeRTOS1_xTaskResumeAll() \
  xTaskResumeAll()
/*
** ===================================================================
...
#define FreeRTOS1_vTaskDelay(xTicksToDelay) \
...
#define FreeRTOS1_vTaskDelayUntil(pxPreviousWakeTime, xTimeIncrement) \
...
#define FreeRTOS1_uxTaskPriorityGet(pxTask) \
...
#define FreeRTOS1_vTaskPrioritySet(pxTask, uxNewPriority) \
...
#define FreeRTOS1_xSemaphoreTakeRecursive(xMutex, xBlockTime) \
...
#define FreeRTOS1_xSemaphoreGiveRecursive(xMutex) \
...
#define FreeRTOS1_xSemaphoreCreateRecursiveMutex() \
  xSemaphoreCreateRecursiveMutex()
...
#define FreeRTOS1_vTaskSuspend(pxTaskToSuspend) \
...
#define FreeRTOS1_vTaskResume(pxTaskToResume) \
...
#define FreeRTOS1_xSemaphoreCreateMutex() \
  xSemaphoreCreateMutex()
...
#define FreeRTOS1_xSemaphoreTake(xMutex, xBlockTime) \
...
#define FreeRTOS1_xSemaphoreGive(xMutex) \
...
#define FreeRTOS1_vSemaphoreCreateBinary(xSemaphore) \
...
#define FreeRTOS1_xSemaphoreCreateCounting(uxMaxCount, uxInitialCount) \
...
#define FreeRTOS1_xSemaphoreGiveFromISR(xSemaphore, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_vSemaphoreDelete(xSemaphore) \
...
#define FreeRTOS1_vTaskList(pcWriteBuffer, bufSize) \
...
#define FreeRTOS1_pvPortMalloc(xWantedSize) \
...
#define FreeRTOS1_xTaskGetTickCount() \
  xTaskGetTickCount()
/*
** ===================================================================
...
#define FreeRTOS1_xTaskGetSchedulerState() \
...
#define FreeRTOS1_uxTaskGetStackHighWaterMark(xTask) \
...
#define FreeRTOS1_uxTaskGetNumberOfTasks() \
...
#define FreeRTOS1_vTaskGetRunTimeStats(pcWriteBuffer, bufSize) \
...
#define FreeRTOS1_xPortGetFreeHeapSize() \
...
#define FreeRTOS1_xQueueCreate(uxQueueLength, uxItemSize) \
...
#define FreeRTOS1_xQueueSendToFront(xQueue, pvItemToQueue, xTicksToWait) \
...
#define FreeRTOS1_xQueueSendToBack(xQueue, pvItemToQueue, xTicksToWait) \
...
#define FreeRTOS1_xQueueReceive(xQueue, pvBuffer, xTicksToWait) \
...
#define FreeRTOS1_xQueuePeek(xQueue, pvBuffer, xTicksToWait) \
...
#define FreeRTOS1_vQueueDelete(pxQueueToDelete) \
...
#define FreeRTOS1_uxQueueMessagesWaiting(xQueue) \
...
#define FreeRTOS1_uxQueueMessagesWaitingfromISR(xQueue) \
...
#define FreeRTOS1_xQueueReceiveFromISR(xQueue, pvBuffer, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_xQueueSendToFrontFromISR(xQueue, pvItemToQueue, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_xQueueSendToBackFromISR(xQueue, pvItemToQueue,pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_xTaskResumeFromISR(pxTaskToResume) \
...
#define FreeRTOS1_xQueueReset(xQueue) \
  xQueueReset(xQueue)
...
#define FreeRTOS1_xSemaphoreGetMutexHolder(xSemaphore) \
...
#define FreeRTOS1_xSemaphoreTakeFromISR(xSemaphore, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_xTaskGetTickCountFromISR() \
...
#define FreeRTOS1_xQueuePeekFromISR(xQueue, pvBuffer, xTicksToWait) \
...
#define FreeRTOS1_xQueueOverwrite(xQueue, pvItemToQueue) \
...
#define FreeRTOS1_xQueueOverwriteFromISR(xQueue, pvItemToQueue, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_vQueueAddToRegistry(xQueue, pcQueueName) \
...
#define FreeRTOS1_vQueueUnregisterQueue(xQueue) \
...
#define FreeRTOS1_xQueueIsQueueFullFromISR(xQueue) \
...
#define FreeRTOS1_xQueueIsQueueEmptyFromISR(xQueue) \
...
#define FreeRTOS1_xEventGroupCreate() \
  xEventGroupCreate()
/*
** ===================================================================
...
#define FreeRTOS1_xEventGroupWaitBits(xEventGroup, uxBitsToWaitFor, xClearOnExit, xWaitForAllBits, xTicksToWait) \
...
#define FreeRTOS1_xEventGroupSetBits(xEventGroup, uxBitsToSet) \
...
#define FreeRTOS1_xEventGroupSetBitsFromISR(xEventGroup, uxBitsToSet, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_xEventGroupClearBits(xEventGroup, uxBitsToSet) \
...
#define FreeRTOS1_xEventGroupClearBitsFromISR(xEventGroup, uxBitsToSet) \
...
#define FreeRTOS1_xEventGroupGetBits(xEventGroup) \
...
#define FreeRTOS1_xEventGroupGetBitsFromISR(xEventGroup) \
...
#define FreeRTOS1_xEventGroupSync(xEventGroup, uxBitsToSet, uxBitsToWaitFor, xTicksToWait) \
...
#define FreeRTOS1_xTimerCreate(pcTimerName, xTimerPeriod, uxAutoReload, pvTimerID, pxCallbackFunction) \
...
#define FreeRTOS1_xTimerIsTimerActive(xTimer) \
...
#define FreeRTOS1_xTimerStart(xTimer, xBlockTime) \
...
#define FreeRTOS1_xTimerStop(xTimer, xBlockTime) \
...
#define FreeRTOS1_xTimerChangePeriod(xTimer, xNewPeriod, xBlockTime) \
...
#define FreeRTOS1_xTimerDelete(xTimer, xBlockTime) \
...
#define FreeRTOS1_xTimerReset(xTimer, xBlockTime) \
...
#define FreeRTOS1_xTimerStartFromISR(xTimer, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_xTimerStopFromISR(xTimer, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_xTimerChangePeriodFromISR(xTimer, xNewPeriod, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_xTimerResetFromISR(xTimer, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_pvTimerGetTimerID(xTimer) \
...
#define FreeRTOS1_xTimerGetTimerDaemonTaskHandle() \
...
#define FreeRTOS1_pcTimerGetTimerName(xTimer) \
...
#define FreeRTOS1_xTimerPendFunctionCall(xFunctionToPend, pvParameter1, ulParameter2, xTicksToWait) \
...
#define FreeRTOS1_xTimerPendFunctionCallFromISR(xFunctionToPend, pvParameter1, ulParameter2, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_xTaskNotifyGive(xTaskToNotify) \
...
#define FreeRTOS1_ulTaskNotifyTake(xClearCountOnExit, xTicksToWait) \
...
#define FreeRTOS1_vTaskNotifyGiveFromISR(xTaskToNotify, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_xTaskNotify(xTaskToNotify, ulValue, eAction) \
...
#define FreeRTOS1_xTaskNotifyFromISR(xTaskToNotify, ulValue, eAction, pxHigherPriorityTaskWoken) \
...
#define FreeRTOS1_xTaskNotifyWait(ulBitsToClearOnEntry, ulBitsToClearOnExit, pulNotificationValue, xTicksToWait) \
